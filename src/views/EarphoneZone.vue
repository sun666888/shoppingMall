<template>
    <div class="home">
        <div class="title">
            ...
            <p class="seckilltop">耳机&nbsp;专区</p>
        </div>
        <div class="centerlistkong" v-show="chanpin">
            <p>宝贝已售罄，敬请期待产品上新哦~</p>
        </div>
        <div class="centerlist" v-show="!chanpin">
            <div class="list father" v-for="(order, index) in orders" :key="index">
                <a :href="order.introduce"><img :src="img + order.cover" alt="" srcset="" class="fl"></a>
                ...
                <a :href="order.introduce"><span class="listSpan3 fr"></span></a>
            </div>
        </div>
...
<script>
import { erJiList } from "./services/home";
